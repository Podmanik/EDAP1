...
##Write the fourth .png
png(file="plot4.png", height=480, width=480)
par(mfrow=c(2,2))
plot(consumsub$timestamp,consumsub$Global_active_power,type="o",pch=26,xlab="",ylab="Global Active Power",main="")
plot(consumsub$timestamp,consumsub$Voltage,type="o",pch=26,xlab="datetime",ylab="Voltage",main="")
...
##bty='n' specifies no box, as shown in the assignment
legend("topright", lty = 1, col = c("black", "red","blue"), legend = c("Sub_metering_1", "Sub_metering_2","Sub_metering_3"),bty='n')
plot(consumsub$timestamp,consumsub$Global_reactive_power,type="o",pch=26,xlab="datetime",ylab="Global_reactive_power",main="")
dev.off()